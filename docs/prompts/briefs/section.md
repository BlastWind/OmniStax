...
5. Build into your scratch, serve, Playwright in light and dark: no console or page errors, images load, every `figure.sim` has a canvas, transports only on moving figures, the section's text ends on the practice button. One fix pass. Screenshots at 1400 wide.
