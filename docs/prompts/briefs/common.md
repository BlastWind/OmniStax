...
- Scratch: `<scratch dir>/<your task>/`; scripts longer than a line go in a file there. Port: the one your launch message gives. Python 3 with Playwright is installed; `python3 -m http.server <port> -d <dir>` serves a build.
