/* The content as tables. Three files hold the book — book.json, a chapter.json
   ...
   docs/claude/content-format.md is generated from these objects and the
...
export const FigureSchema = z.object({
  ...
  originals: z.array(z.string()).default([]).describe('The book\u2019s own images of the figure, served under public/media, which the reader can call up beside the simulation.'),
...
const ExerciseFigureSchema = z.object({
  src: z.string().describe('The image the problem refers to, served under public/media.'),
