...
export const zExercise = z.object({
  ...
  weights: z.record(z.number()).optional(), weights_by: z.enum(['ai']).optional(),   /* points per concept the exercise leans on, written by the pipeline and marked as generated; absent means the Bloom table applies */
