...
{term:Matter} is defined as anything that occupies space and has mass, and it is all around us. Solids and liquids are more obviously matter: We can see that they take up space, and their weight tells us that they have mass. Gases are also matter; if gases did not take up space, a balloon would not inflate (increase its volume) when filled with gas.
Solids, liquids, and gases are the three states of matter commonly found on earth ([ref:CNX_Chem_01_02_StatesMatt]). A {term:solid} is rigid and possesses a definite shape. A {term:liquid} flows and takes the shape of its container, except that it forms a flat or slightly curved upper surface when acted upon by gravity. (In zero gravity, liquids assume a spherical shape.) Both liquid and solid samples have volumes that are very nearly independent of pressure. A {term:gas} takes both the shape and volume of its container.

> FIGURE {fig:CNX_Chem_01_02_StatesMatt} src=../../media/CNX_Chem_01_02_StatesMatt.jpg
...
A fourth state of matter, plasma, occurs naturally in the interiors of stars. A {term:plasma} is a gaseous state of matter that contains appreciable numbers of electrically charged particles ([ref:CNX_Chem_01_02_Plasma]). The presence of these charged particles imparts unique properties to plasmas that justify their classification as a state of matter distinct from gases. In addition to stars, plasmas are found in some other high-temperature environments (both natural and man-made), such as lightning strikes, certain television screens, and specialized analytical instruments used to detect trace amounts of metals.

> FIGURE {fig:CNX_Chem_01_02_Plasma} src=../../media/CNX_Chem_01_02_Plasma.jpg class=scaled-down
> alt: A cutting torch is being used to cut a piece of metal. Bright, white colored plasma can be seen near the tip of the torch, where it is contacting the metal.
...
## Classifying Matter
Matter can be classified into several categories. Two broad categories are mixtures and pure substances. A {term:pure substance} has a constant composition. All specimens of a pure substance have exactly the same makeup and properties. Any sample of sucrose (table sugar) consists of 42.1% carbon, 6.5% hydrogen, and 51.4% oxygen by mass. Any sample of sucrose also has the same physical properties, such as melting point, color, and sweetness, regardless of the source from which it is isolated.
Pure substances may be divided into two classes: elements and compounds. Pure substances that cannot be broken down into simpler substances by chemical changes are called {term:elements}. Iron, silver, gold, aluminum, sulfur, oxygen, and copper are familiar examples of the more than 100 known elements, of which about 90 occur naturally on the earth, and two dozen or so have been created in laboratories.
Pure substances that are comprised of two or more elements are called {term:compounds}. Compounds may be broken down by chemical changes to yield either elements or other compounds, or both. Mercury(II) oxide, an orange, crystalline solid, can be broken down by heat into the elements mercury and oxygen ([ref:CNX_Chem_01_02_decomp]). When heated in the absence of air, the compound sucrose is broken down into the element carbon and the compound water. (The initial stage of this process, when the sugar is turning brown, is known as caramelization—this is what imparts the characteristic sweet and nutty flavor to caramel apples, caramelized onions, and caramel). Silver(I) chloride is a white solid that can be broken down into its elements, silver and chlorine, by absorption of light. This property is the basis for the use of this compound in photographic films and photochromic eyeglasses (those with lenses that darken when exposed to light).

> FIGURE {fig:CNX_Chem_01_02_decomp} src=../../media/CNX_Chem_01_02_decomp.jpg class=scaled-down
...
> FIGURE {fig:CNX_Chem_01_02_MattType} src=../../media/CNX_Chem_01_02_MattType.jpg
...
> TABLE {tab:fs-idp31507504} cols=6 class=top-titled
...
## Atoms and Molecules
An {term:atom} is the smallest particle of an element that has the properties of that element and can enter into a chemical combination. Consider the element gold, for example. Imagine cutting a gold nugget in half, then cutting one of the halves in half, and repeating this process until a piece of gold remained that was so small that it could not be cut in half (regardless of how tiny your knife may be). This minimally sized piece of gold is an atom (from the Greek *atomos*, meaning “indivisible”) ([ref:CNX_Chem_01_02_GoldAtoms]). This atom would no longer be gold if it were divided any further.

> FIGURE {fig:CNX_Chem_01_02_GoldAtoms} src=../../media/CNX_Chem_01_02_GoldAtoms.jpg
...
> FIGURE {fig:CNX_Chem_01_02_Cellulose} src=../../media/CNX_Chem_01_02_Cellulose.jpg
...
:::note [chemistry everyday-life] Decomposition of Water / Production of Hydrogen
...
> FIGURE {fig:CNX_Chem_01_01_Electrolys} src=../../media/CNX_Chem_01_01_Electrolys.jpg
> alt: A rectangular battery is immersed in a beaker of liquid water, with each terminal covered by an inverted test tube collecting bubbles of gas. The test tube over the negative terminal is approximately twice as full of gas as the one over the positive terminal, reflecting the 2:1 ratio of hydrogen to oxygen produced. Arrows indicate the liquid in the beaker is 2 H subscript 2 O liquid, the gas in the negative tube is 2 H subscript 2 gas, and the gas in the positive tube is O subscript 2 gas.
> caption: The decomposition of water is shown at the macroscopic, microscopic, and symbolic levels. The battery provides an electric current (microscopic) that decomposes water. At the macroscopic level, the liquid separates into the gases hydrogen (on the left) and oxygen (on the right). Symbolically, this change is presented by showing how liquid H<sub>2</sub>O separates into H<sub>2</sub> and O<sub>2</sub> gases.

The breakdown of water involves a rearrangement of the atoms in water molecules into different molecules, each composed of two hydrogen atoms and two oxygen atoms, respectively. Two water molecules form one oxygen molecule and two hydrogen molecules. The representation for what occurs, $2{\text{H}}_{2}\text{O}(l)\;\longrightarrow \;2{\text{H}}_{2}(g)+{\text{O}}_{2}(g)\text{,}$ will be explored in more depth in later chapters.
...
> FIGURE {fig:CNX_Chem_01_01_FuelCell} src=../../media/CNX_Chem_01_01_FuelCell.jpg class=scaled-down
...
:::note [chemistry everyday-life] Chemistry of Cell Phones
...
> FIGURE {fig:CNX_Chem_01_02_CellPhone} src=../../media/CNX_Chem_01_02_CellPhone.jpg
...
$$ \text{glucose}\;\longrightarrow \;\text{ethanol}+\text{carbon dioxide} $$  {eq:fs-idp17770496}
...
## Glossary
- {def} **atom**: smallest particle of an element that can enter into a chemical combination
- {def} **compound**: pure substance that can be decomposed into two or more elements
- {def} **element**: substance that is composed of a single type of atom; a substance that cannot be decomposed by a chemical change
- {def} **gas**: state in which matter has neither definite volume nor shape
- {def} **heterogeneous mixture**: combination of substances with a composition that varies from point to point
- {def} **homogeneous mixture**: (also, solution) combination of substances with a composition that is uniform throughout
- {def} **liquid**: state of matter that has a definite volume but indefinite shape
- {def} **law of conservation of matter**: when matter converts from one type to another or changes form, there is no detectable change in the total amount of matter present
- {def} **mass**: fundamental property indicating amount of matter
- {def} **matter**: anything that occupies space and has mass
- {def} **mixture**: matter that can be separated into its components by physical means
- {def} **molecule**: bonded collection of two or more atoms of the same or different elements
- {def} **plasma**: gaseous state of matter containing a large number of electrically charged atoms and/or molecules
- {def} **pure substance**: homogeneous substance that has a constant composition
- {def} **solid**: state of matter that is rigid, has a definite shape, and has a fairly constant volume
- {def} **solution (also, homogeneous mixture)**: combination of substances with a composition that is uniform throughout
- {def} **weight**: force that gravity exerts on an object
