...
> FIGURE {fig:import-auto-id1697715} src=../../media/Figure_19_00_01a_D.jpg class=splash
> alt: A child swoops down a plastic playground slide, his hair standing on end.
...
The image of American politician and scientist Benjamin Franklin (1706–1790) flying a kite in a thunderstorm is familiar to many schoolchildren. (See [ref:import-auto-id1492127].) In this experiment, Franklin demonstrated a connection between lightning and {term:static electricity}. Sparks were drawn from a key hung on a kite string during an electrical storm. These sparks were like those produced by static electricity, such as the spark that jumps from your finger to a metal doorknob after you walk across a wool carpet. What Franklin demonstrated in his dangerous experiment was a connection between phenomena on two different scales: one the grand power of an electrical storm, the other an effect of more human proportions. Connections like this one reveal the underlying unity of the laws of nature, an aspect we humans find particularly appealing.

> FIGURE {fig:import-auto-id1492127} src=../../media/Figure_19_00_02a.jpg
> alt: Benjamin Franklin is shown flying a kite and lightning is observed. A metal key is attached to the string.
> width: 275
...
Atomic and molecular interactions, such as the forces of friction, cohesion, and adhesion, are now known to be manifestations of the {term:electromagnetic force}. Static electricity is just one aspect of the electromagnetic force, which also includes moving electricity and magnetism.
...
[OpenStax AP Physics Chapter 18: Electric Fields Physics Concept Trailer](https://www.youtube.com/embed/SglzRDD1oNI)

## Glossary
- {def} **static electricity**: a buildup of electric charge on the surface of an object
- {def} **electromagnetic force**: one of the four fundamental forces of nature; the electromagnetic force consists of static electricity, moving electricity and magnetism
