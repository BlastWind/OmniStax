...
The Scotsman James Clerk Maxwell (1831–1879) is regarded as the greatest theoretical physicist of the 19th century. (See [ref:import-auto-id1169738037078].) Although he died young, Maxwell not only formulated a complete electromagnetic theory, represented by {term:Maxwell’s equations}, he also developed the kinetic theory of gases and made significant contributions to the understanding of color vision and the nature of Saturn’s rings.

> FIGURE {fig:import-auto-id1169738037078} src=../../media/Figure 25_01_01a.jpg
> alt: This black and white engraving shows physicist James Clerk Maxwell as a Victorian era gentleman dressed in bowtie, vest, and jacket, and sporting a full, graying beard and moustache.
> width: 175
...
:::note [] Maxwell’s Equations

1. {term:Electric field lines} originate on positive charges and terminate on negative charges. The electric field is defined as the force per unit charge on a test charge, and the strength of the force is related to the electric constant ${ε}_{0}$, also known as the permittivity of free space. From Maxwell’s first equation we obtain a special form of Coulomb’s law known as Gauss’s law for electricity.
2. {term:Magnetic field lines} are continuous, having no beginning or end. No magnetic monopoles are known to exist. The strength of the magnetic force is related to the magnetic constant ${μ}_{0}$, also known as the permeability of free space. This second of Maxwell’s equations is known as Gauss’s law for magnetism.
...
$$ c=\frac{1}{\sqrt{{μ}_{0}{ε}_{0}}}. $$  {eq:eip-556}

When the values for ${μ}_{0}$ and ${ε}_{0}$ are entered into the equation for $c$, we find that

$$ c=\frac{1}{\sqrt{(8\text{.}\text{85}\times {\text{10}}^{-\text{12}}\;\frac{{\text{C}}^{2}}{\text{N}⋅{\text{m}}^{2}})(4π×{\text{10}}^{-7}\;\frac{\text{T}⋅\text{m}}{\text{A}})}}=\text{3}\text{.}\text{00}\times {\text{10}}^{8}\;\text{m/s}, $$  {eq:eip-394}
...
> FIGURE {fig:import-auto-id1169738181556} src=../../media/Figure 25_01_02a.jpg
...
$$ c=\frac{1}{\sqrt{{μ}_{0}{ε}_{0}}}, $$  {eq:eip-672}

where ${μ}_{0}$ is the permeability of free space and ${ε}_{0}$ is the permittivity of free space.
...
:::exercise {fs-id1169738137813} type=problems-exercises 
PROBLEM:
Verify that the correct value for the speed of light $c$ is obtained when numerical values for the permeability and permittivity of free space (${μ}_{0}$ and ${ε}_{0}$) are entered into the equation $c=\frac{1}{\sqrt{{μ}_{0}{ε}_{0}}}$.
:::

:::exercise {fs-id1169738015970} type=problems-exercises 
PROBLEM:
Show that, when SI units for ${μ}_{0}$ and ${ε}_{0}$ are entered, the units given by the right-hand side of the equation in the problem above are m/s.
:::

## Glossary
- {def} **electromagnetic waves**: radiation in the form of waves of electric and magnetic energy
- {def} **Maxwell’s equations**: a set of four equations that comprise a complete, overarching theory of electromagnetism
- {def} ***RLC* circuit**: an electric circuit that includes a resistor, capacitor and inductor
- {def} **hertz**: an SI unit denoting the frequency of an electromagnetic wave, in cycles per second
- {def} **speed of light**: in a vacuum, such as space, the speed of light is a constant 3 x 10<sup>8</sup> m/s
- {def} **electromotive force (emf)**: energy produced per unit charge, drawn from a source that produces an electrical current
- {def} **electric field lines**: a pattern of imaginary lines that extend between an electric source and charged objects in the surrounding area, with arrows pointed away from positively charged objects and toward negatively charged objects. The more lines in the pattern, the stronger the electric field in that region
- {def} **magnetic field lines**: a pattern of continuous, imaginary lines that emerge from and enter into opposite magnetic poles. The density of the lines indicates the magnitude of the magnetic field
