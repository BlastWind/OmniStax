...
> FIGURE {fig:import-auto-id1750359} src=../../media/FIgure_23_01_01a.jpg
> alt: Bar magnets, horseshoe magnets, and disc-shaped magnets attract and repel each other. Metal paperclips stick to some of the magnets.
> width: 320
...
> FIGURE {fig:import-auto-id945200} src=../../media/Figure_23_01_02a.jpg
...
:::note [] Misconception Alert: Earth’s Magnetic Poles
...
> FIGURE {fig:import-auto-id2869574} src=../../media/Figure_23_01_03a.jpg
...
> FIGURE {fig:import-auto-id1660354} src=../../media/Figure_23_01_04a.jpg
> alt: A bar magnet is split in half several times. The original magnet has a south pole and a north pole. Each time the magnet is split, each new half has both a south pole and a north pole.
> width: 200
...
:::note [] Making Connections: Take-Home Experiment—Refrigerator Magnets
...
:::exercise {fs-id1735677} type=conceptual-questions 
PROBLEM:
...
## Glossary
- {def} **north magnetic pole**: the end or the side of a magnet that is attracted toward Earth’s geographic north pole
- {def} **south magnetic pole**: the end or the side of a magnet that is attracted toward Earth’s geographic south pole
