...
Einstein is said to have been fascinated by a compass as a child, perhaps musing on how the needle felt a force without direct physical contact. His ability to think deeply and clearly about action at a distance, particularly for gravitational, electric, and magnetic forces, later enabled him to create his revolutionary theory of relativity. Since magnetic forces act at a distance, we define a {term:magnetic field} to represent magnetic forces. The pictorial representation of {term:magnetic field lines} is very useful in visualizing the strength and direction of the magnetic field. As shown in [ref:import-auto-id1636233], the {term:direction of magnetic field lines}  is defined to be the direction in which the north end of a compass needle points. The magnetic field is traditionally called the {term:*B*-field}.

> FIGURE {fig:import-auto-id1636233} src=../../media/Figure_23_03_01a.jpg
...
:::note [] Making Connections: Concept of a Field
...
:::exercise {fs-id1427275} type=conceptual-questions 
PROBLEM:
...
:::exercise {fs-id1726799} type=conceptual-questions 
PROBLEM:
...
:::exercise {fs-id1976818} type=conceptual-questions 
PROBLEM:
...
:::exercise {fs-id1404960} type=conceptual-questions 
PROBLEM:
...
## Glossary
- {def} **magnetic field**: the representation of magnetic forces
- {def} ***B*-field**: another term for magnetic field
- {def} **magnetic field lines**: the pictorial representation of the strength and the direction of a magnetic field
- {def} **direction of magnetic field lines**: the direction that the north end of a compass needle points
