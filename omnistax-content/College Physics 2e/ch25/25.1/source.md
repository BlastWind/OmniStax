...
There are three ways in which light can travel from a source to another location. (See [ref:import-auto-id3255994].) It can come directly from the source through empty space, such as from the Sun to Earth. Or light can travel through various media, such as air and glass, to the person. Light can also arrive after being reflected, such as by a mirror. In all of these cases, light is modeled as traveling in straight lines called rays. Light may change direction when it encounters objects (such as a mirror) or in passing from one material to another (such as in passing from air to glass), but it then continues in a straight line or as a ray. The word {term:ray} comes from mathematics and here means a straight line that originates at some point. It is acceptable to visualize light rays as laser rays (or even science fiction depictions of ray guns).
...
> FIGURE {fig:import-auto-id3255994} src=../../media/Figure 26_01_01.jpg
> alt: This diagram shows the sun's rays reaching Earth in (a), and in (b), illustrates sunlight entering a room through a window, reflecting off a car outside. It highlights how solar energy interacts with different environments.
> width: 250
...
Since light moves in straight lines, changing directions when it interacts with materials, it is described by geometry and simple trigonometry. This part of optics, where the ray aspect of light dominates, is therefore called {term:geometric optics}. There are two laws that govern how light changes direction when it interacts with matter. These are the law of reflection, for situations in which light bounces off matter, and the law of refraction, for situations in which light passes through matter.

:::note [] Geometric Optics
...
:::exercise {fs-id1419353} type=ap-test-prep 
PROBLEM:
...
:::exercise {fs-id1865105} type=ap-test-prep 
PROBLEM:
...
:::exercise {fs-id3065345} type=problem-exercises 
PROBLEM:
Suppose a man stands in front of a mirror as shown in [ref:import-auto-id2633842]. His eyes are 1.65 m above the floor, and the top of his head is 0.13 m higher. Find the height above the floor of the top and bottom of the smallest mirror in which he can see both the top of his head and his feet. How is this distance related to the man’s height?

> FIGURE {fig:import-auto-id2633842} src=../../media/Figure 26_01_02.jpg
> alt: A man standing in front of a mirror on a wall at a distance of several feet. The mirror’s top is at eye level, but its bottom is only waist high. Arrows illustrate how the man can see his reflection from head to toe in the mirror.
> width: 150
> caption: A full-length mirror is one in which you can see all of yourself. It need not be as big as you, and its size is independent of your distance from it.
...
## Glossary
- {def} **ray**: straight line that originates at some point
- {def} **geometric optics**: part of optics dealing with the ray aspect of light
