...
> FIGURE {fig:import-auto-id3162262} src=../../media/Figure_17_00_01a.jpg
> alt: In the figure a couple and their son are sitting alongside a beach in the evening time, around a wood-lit fire. The man is playing a guitar.
...
[OpenStax AP Physics Chapter 16: Harmonic Motion (Physics Concept Trailer™)](https://www.youtube.com/embed/9KMpE6BGz5Q)

## Glossary
- {def} **oscillate**: moving back and forth regularly between two points
- {def} **wave**: a disturbance that moves from its source and carries energy
