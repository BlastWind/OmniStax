...
> FIGURE {fig:import-auto-id1788945} src=../../media/Figure_02_06_00.jpg
> alt: Close-up photo of a hand writing in a notebook. On top of the notebook is a graphing calculator.
...
$$ v={v}_{0}+\text{at}=0+(0\text{.}\text{40}\;{\text{m/s}}^{2})(\text{100}\;\text{s})=\text{40}\;\text{m/s}. $$  {eq:import-auto-id4167672}
...
$$ (\frac{\text{40 m}}{s})(\frac{\text{3.28 ft}}{m})(\frac{\text{1 mi}}{\text{5280 ft}})(\frac{\text{60 s}}{\text{min}})(\frac{\text{60 min}}{\text{1 h}})=89 mph $$  {eq:import-auto-id1437508}
