...
> FIGURE {fig:import-auto-id1580373} src=../../media/Figure_01_01_01_aa.jpg
> alt: Two Canada geese flying close to each other in the sky.
...
You need not be a scientist to use physics. On the contrary, knowledge of physics is useful in everyday situations as well as in nonscientific professions. It can help you understand how microwave ovens work, why metals should not be put into them, and why they might affect pacemakers. (See [ref:import-auto-id1301457] and [ref:import-auto-id2543552].) Physics allows you to understand the hazards of radiation and rationally evaluate these hazards more easily. Physics also explains the reason why a black car radiator helps remove heat in a car engine, and it explains why a white roof helps keep the inside of a house cool. Similarly, the operation of a car’s ignition system as well as the transmission of electrical signals through our body’s nervous system are much easier to understand when you think about them in terms of basic physics.
...
Physics has many applications in the biological sciences. On the microscopic level, it helps describe the properties of cell walls and cell membranes ([ref:import-auto-id2821668] and [ref:import-auto-id1622392]). On the macroscopic level, it can explain the heat, work, and power associated with the human body. Physics is involved in medical diagnostics, such as x-rays, magnetic resonance imaging (MRI), and ultrasonic blood flow measurements. Medical therapy sometimes directly involves physics; for example, cancer radiotherapy uses ionizing radiation. Physics can also explain sensory phenomena, such as how musical instruments make sound, how the eye detects color, and how lasers can transmit information.
...
> FIGURE {fig:import-auto-id1301457} src=../../media/Figure_01_01_03_aa.jpg
> alt: A microwave oven is shown with some food on the nonmetal plate inside it.
...
> FIGURE {fig:import-auto-id2543552} src=../../media/Figure_01_01_04_aa.jpg
> alt: M R I scan of a brain with specific tumors.
...
> FIGURE {fig:import-auto-id2821668} src=../../media/Figure_01_01_05_aa.jpg
> alt: Cell membranes of onion cells, similar in appearance to a section of a brick wall.
...
> FIGURE {fig:import-auto-id1596747} src=../../media/Figure_01_01_08_aa.jpg
> alt: A photograph of Marie Curie
...
> FIGURE {fig:fs-id1165298745067} src=../../media/Figure_01_01_09_aa.jpg
> alt: A planetary model of an atom with a positively charged nucleus at the center and negatively charged particles moving in orbits around the nucleus.
...
Physics was not always a separate and distinct discipline. It remains connected to other sciences to this day. The word *physics* comes from Greek, meaning nature. The study of nature came to be called “natural philosophy.” From ancient times through the Renaissance, natural philosophy encompassed many fields, including astronomy, biology, chemistry, physics, mathematics, and medicine. Over the last few centuries, the growth of knowledge has resulted in ever-increasing specialization and branching of natural philosophy into separate fields, with physics retaining the most basic facets. (See [ref:import-auto-id3143608], [ref:import-auto-id2681333], and [ref:import-auto-id2681780].) Physics as it developed from the Renaissance to the end of the 19th century is called {term:classical physics}. It was transformed into modern physics by revolutionary discoveries made starting at the beginning of the 20th century.

> FIGURE {fig:import-auto-id3143608} src=../../media/Figure_01_01_10_aa.jpg
> alt: A marble statue of Aristotle.
...
> FIGURE {fig:import-auto-id2681333} src=../../media/OSX_CP2e_Figure_01_01_11.jpg
> alt: The cover of book by Hevelius. Pictured are al-Haytham and Galilei standing on pedestals on either side of the title inscription, which reads Selonographia. Al-Haytham's pedestal has the Latin word for “Reason” and Galilei's has the Latin word for “Sense.”
> caption: Ibn al-Haytham (965–1040) and Galileo Galilei (1564–1642) were so critical to the advancement of scientific practice and to the fields of mathematics, optics, physics, and astronomy that a later prominent scientist featured them on the cover of his major work. (credit: Johannes Hevelius (author), Adolph Boÿ (artist), J. Falck (engraver); Houghton Library, Harvard University/Wikimedia Commons)

> FIGURE {fig:import-auto-id2681780} src=../../media/Figure_01_01_12_aa.jpg
> alt: A photograph of Niels Bohr
...
:::note [] Limits on the Laws of Classical Physics
...
> FIGURE {fig:import-auto-id2990813} src=../../media/Figure_01_01_13_aa.jpg
> alt: A high-resolution image of gold sheet obtained from S T M.
...
:::exercise {fs-id2592493} type=conceptual-questions 
PROBLEM:
...
:::exercise {fs-id2966113} type=conceptual-questions 
PROBLEM:
How does a model differ from a theory?
:::

:::exercise {fs-id2633201} type=conceptual-questions 
PROBLEM:
...
:::exercise {fs-id3137988} type=conceptual-questions 
PROBLEM:
What determines the validity of a theory?
:::

:::exercise {fs-id2629517} type=conceptual-questions 
PROBLEM:
...
:::exercise {fs-id2790873} type=conceptual-questions 
PROBLEM:
...
:::exercise {fs-id1573492} type=conceptual-questions 
PROBLEM:
Classical physics is a good approximation to modern physics under certain circumstances. What are they?
:::

:::exercise {fs-id1590524} type=conceptual-questions 
PROBLEM:
When is it *necessary* to use relativistic quantum mechanics?
:::

:::exercise {fs-id2757381} type=conceptual-questions 
PROBLEM:
Can classical physics be used to accurately describe a satellite moving at a speed of 7500 m/s? Explain why or why not.
:::

## Glossary
- {def} **classical physics**: physics that was developed from the Renaissance to the end of the 19th century
- {def} **physics**: the science concerned with describing the interactions of energy, matter, space, and time; it is especially interested in what fundamental mechanisms underlie every phenomenon
- {def} **model**: representation of something that is often too difficult (or impossible) to display directly
- {def} **theory**: an explanation for patterns in nature that is supported by scientific evidence and verified multiple times by various groups of researchers
- {def} **law**: a description, using concise language or a mathematical formula, a generalized pattern in nature that is supported by scientific evidence and repeated experiments
- {def} **scientific method**: a method that typically begins with an observation and question that the scientist will research; next, the scientist typically performs some research about the topic and then devises a hypothesis; then, the scientist will test the hypothesis by performing an experiment; finally, the scientist analyzes the results of the experiment and draws a conclusion
- {def} **modern physics**: the study of relativity, quantum mechanics, or both
- {def} **relativity**: the study of objects moving at speeds greater than about 1% of the speed of light, or of objects being affected by a strong gravitational field
- {def} **quantum mechanics**: the study of objects smaller than can be seen with a microscope
