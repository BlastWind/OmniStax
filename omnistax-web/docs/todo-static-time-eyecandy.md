...
- [x] **Pass: widgets** on 2.5: 7 hand-coded sims, one in 3D (`omnistax-content/College Physics 2e/ch02/2.5/figures.js`). Identify which figures and paragraphs deserve an interactive. Draft a widget spec for two or three of them by hand. Note what the spec needs to express.
